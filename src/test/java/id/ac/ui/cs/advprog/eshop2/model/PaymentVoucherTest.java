...
public class PaymentVoucherTest {
    ...
    void testVoucherValidSuccess() {
        ...
        Payment payment = new Payment("pay-1", null, "VOUCHER", paymentData);
    ...
    void testVoucherValidDifferentLetters() {
        ...
        Payment payment = new Payment("pay-2", null, "VOUCHER", paymentData);
        assertEquals(PaymentStatus.SUCCESS.getValue(), payment.getStatus());
    }
    ...
    void testVoucherNullCodeRejected() {
        ...
        Payment payment = new Payment("pay-3", null, "VOUCHER", paymentData);
        assertEquals(PaymentStatus.REJECTED.getValue(), payment.getStatus());
    }

    @Test
    void testVoucherMissingKeyRejected() {
        Payment payment = new Payment("pay-4", null, "VOUCHER", paymentData);
        assertEquals(PaymentStatus.REJECTED.getValue(), payment.getStatus());
    }
    ...
    void testVoucherTooShortRejected() {
        ...
        Payment payment = new Payment("pay-5", null, "VOUCHER", paymentData);
        assertEquals(PaymentStatus.REJECTED.getValue(), payment.getStatus());
    }
    ...
    void testVoucherTooLongRejected() {
        ...
        Payment payment = new Payment("pay-6", null, "VOUCHER", paymentData);
        assertEquals(PaymentStatus.REJECTED.getValue(), payment.getStatus());
    }
    ...
    void testVoucherNotStartWithESHOPRejected() {
        ...
        Payment payment = new Payment("pay-7", null, "VOUCHER", paymentData);
        assertEquals(PaymentStatus.REJECTED.getValue(), payment.getStatus());
    }
    ...
    void testVoucherLowercaseESHOPRejected() {
        paymentData.put("voucherCode", "eshop1234ABC5678");
        Payment payment = new Payment("pay-8", null, "VOUCHER", paymentData);
        assertEquals(PaymentStatus.REJECTED.getValue(), payment.getStatus());
    }
    ...
    void testVoucherTooFewDigitsRejected() {
        ...
        Payment payment = new Payment("pay-9", null, "VOUCHER", paymentData);
        assertEquals(PaymentStatus.REJECTED.getValue(), payment.getStatus());
    }
    ...
    void testVoucherTooManyDigitsRejected() {
        ...
        Payment payment = new Payment("pay-10", null, "VOUCHER", paymentData);
        assertEquals(PaymentStatus.REJECTED.getValue(), payment.getStatus());
    }
    ...
    void testVoucherSevenDigitsRejected() {
        ...
        Payment payment = new Payment("pay-11", null, "VOUCHER", paymentData);
        assertEquals(PaymentStatus.REJECTED.getValue(), payment.getStatus());
    }
    ...
    void testVoucherLowercaseCharNotCountedAsDigit() {
        ...
        Payment payment = new Payment("pay-12", null, "VOUCHER", paymentData);
        assertEquals(PaymentStatus.REJECTED.getValue(), payment.getStatus());
    }
}